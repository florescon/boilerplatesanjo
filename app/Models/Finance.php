...
class Finance extends Model
{
    ...
    public function getOrderTrackAttribute(): ?string
    {
        if($this->order_id !== null){
            return $this->order ? '<a href="'.route($this->isFromStore() ? 'admin.store.all.edit' : 'admin.order.edit', $this->order_id, $this->order_id).'"><strong>'.$this->order->slug.'</strong></a>' : "<span class='badge badge-secondary'>".__('undefined order/sale').'</span>';
        }
