...
use App\Exports\ServicesRecordsExport;
use Excel;

class ServiceRecordsTable extends Component
{
    ...
    {   
        ...
        return Excel::download(new ServicesRecordsExport($this->getSelectedRecords()), 'services-records-list.'.$extension);
    }
    ...
    {
        return view('backend.service.table.service-records-table', [
            'records' => $this->rows,
        ]);
    }
}
