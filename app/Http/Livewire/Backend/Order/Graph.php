    ...
    public function getSankeyData()
    {
        ...
        $productOrders = DB::table('product_order as po')
            ...
            ->select([
                ...
                DB::raw('SUM(po.quantity) as quantity_order'),
            ])
            ->groupBy([
                'po.order_id',
                'p.parent_id',
        ...
        $data = DB::table('material_orders as mo')
            ...
            ->where('mo.order_id', $this->order->id)
...
foreach ($productOrders as $row) {
    ...
    */
    ...
    {
        return view('backend.order.livewire.graph');
    }
}
