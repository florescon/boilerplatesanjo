...
namespace App\Http\Livewire\Backend\Logos;
...
class LogoTable extends Component
{
    ...
    public function savePictures()
    {
        ...
        $allImages = Image::whereType('2')->count();
    ...
    {
        return redirect()->route('admin.setting.logos');
    }
    ...
    {
        return view('backend.setting.livewire.logo-table', [
            'logos' => $this->rows,
        ]);
    }
}
