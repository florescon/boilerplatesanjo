							...
							<div class="section border-4 bg-white landing-shadow-4 p-3 p-xl-4">
								<div class="row">
									...
									<div class="col-12 mt-4">
										<a href="#" class="link link-gray-primary link-normal mb-1 mr-3"><i class="uil uil-twitter size-22"></i></a> 
										<a href="#" class="link link-gray-primary link-normal mb-1 mr-3"><i class="uil uil-facebook-messenger size-22"></i></a>
										<a href="#" class="link link-gray-primary link-normal mb-1 mr-3"><i class="uil uil-slack size-22"></i></a> 
										<a href="#" class="link link-gray-primary link-normal mb-1"><i class="uil uil-linkedin size-22"></i></a>
									</div>
									<div class="col-12 mt-4">
