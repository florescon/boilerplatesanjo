						<div class="home-slider owl-carousel owl-theme owl-carousel-lazy mb-2" data-owl-options="{
							...
							<div class="home-slide home-slide1 banner banner-md-vw banner-sm-vw">
								<img class="owl-lazy slide-bg" src="{{ asset('/porto/assets/images/lazy.png')}}" data-src="{{ asset('/porto/assets/images/slider/slide-1.png')}}" alt="slider image">
							...
							<div class="home-slide home-slide2 banner banner-md-vw banner-sm-vw">
								<img class="owl-lazy slide-bg" src="{{ asset('/porto/assets/images/lazy.png')}}" data-src="{{ asset('/porto/assets/images/slider/slide-2.jpg')}}" alt="slider image">
							...
							<div class="home-slide home-slide3 banner banner-md-vw banner-sm-vw">
								<img class="owl-lazy slide-bg" data-src="{{ asset('/porto/assets/images/slider/slide-3.jpg')}}"></img>
								<div class="banner-layer banner-layer-middle text-uppercase">
