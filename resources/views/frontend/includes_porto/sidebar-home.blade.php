										...
										<div class="megamenu megamenu-fixed-width megamenu-3cols">
											<div class="row">
												...
												<div class="col-lg-4 p-0">
													<img src="{{ asset('/porto/assets/images/menu-banner.jpg')}}" alt="Menu banner">
												</div>
											</div>
										</div><!-- End .megamenu -->
									</li>
										...
										<div class="megamenu megamenu-fixed-width">
											<div class="row">
												...
												<div class="col-lg-3 p-0">
													<img src="{{ asset('/porto/assets/images/menu-bg.png')}}" alt="Menu banner" class="product-promo">
												</div><!-- End .col-lg-4 -->
											</div><!-- End .row -->
										</div><!-- End .megamenu -->
									</li>
							...
							<div class="owl-carousel owl-theme dots-left">
								<div class="testimonial">
									<div class="testimonial-owner">
										<figure>
											<img src="{{ asset('/porto/assets/images/clients/client-1.jpg')}}" alt="client">
										</figure>
								...
								<div class="testimonial">
									<div class="testimonial-owner">
										<figure>
											<img src="{{ asset('/porto/assets/images/clients/client-2.jpg')}}" alt="client">
										</figure>
								...
								<div class="testimonial">
									<div class="testimonial-owner">
										<figure>
											<img src="{{ asset('/porto/assets/images/clients/client-3.jpg')}}" alt="client">
										</figure>
