		<footer class="footer bg-dark">
					...
					<div class="row">
						<div class="col-lg-3 col-sm-6 pb-5 pb-sm-0">
							<div class="widget">
								...
								<img width="140px" src="{{ asset('/porto/assets/images/logo22.png')}}" alt="Logo" class="m-b-3">
			...
			<div class="container">
				<div class="footer-bottom d-flex justify-content-between align-items-center flex-wrap">
					...
					<img src="{{ asset('/porto/assets/images/payments.png')}}" alt="payment methods" class="footer-payments py-3">
				</div>
			</div><!-- End .container -->
		</footer><!-- End .footer -->
