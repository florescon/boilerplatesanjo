        ...
        <div class="row ">
            <div class="col-16 col-md-6">
                ...
                <div class="card card-edit card-product_not_hover card-flyer-without-hover">
                  ...
                  <img class="card-img-top" src="{{ asset('/ga/img/lotes.jpg' )}}" alt="Card image cap">
                    ...
                    @else
                      @foreach($model->batches as $batch)
                        @if($batch->status_id === $previous_status->id)
                          ...
                          #{{ $batch->parent_or_id }} -- {{ optional($batch->personal)->real_name }}
            ...
            <div class="col-12 col-md-6">
              ...
              <p>
                <div class="btn-group" role="group" aria-label="Basic example">
                  @if($previous_status)
                    <a href="{{ route('admin.order.process', [$model->id, $previous_status->id]) }}" class="btn btn-outline-primary" data-toggle="tooltip" title="{{ $previous_status->name ?? null }}"><i class="c-icon  c-icon-4x cil-people"></i> @lang('Previous status')</a>
                  @endif
                  @if($next_status)
                    <a href="{{ route('admin.order.process', [$model->id, $next_status->id]) }}" class="btn btn-outline-primary" data-toggle="tooltip" title="{{ $next_status->name ?? null }}"><i class="c-icon  c-icon-4x cil-people"></i> @lang('Next status')</a>
                  @endif
                </div>
              </p>
              <br>
