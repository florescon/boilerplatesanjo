    ...
    <div class="cs-invoice cs-style1">
      ...
      <div class="cs-invoice_in" id="download_section">
        ...
        <div class="cs-invoice_head cs-type1 cs-mb25">
          <div class="legend">
            <p class="cs-invoice_number cs-primary_color cs-mb0 cs-f16"><b class="cs-primary_color">@lang('Date Range'):</b> 
              {{ \Carbon\Carbon::parse($dateInput)->format('d-m-Y') }} - {{ \Carbon\Carbon::parse($dateOutput)->format('d-m-Y') }}
            </p>
            <p class="cs-invoice_number cs-primary_color cs-mb0 cs-f16"><b class="cs-primary_color">@lang('Created'):</b> 
              {{ now()->isoFormat('D, MMM, YY - h:mm a') }}, @lang('by') {{ auth()->user()->real_name }}
            </p>
            @if(!$summary)
              ...
              <table>
                <thead>
                  <tr class="cs-focus_bg2">
                    @if((count($ordercollection) > 1) && !$summary)
                  ...
                  <tr class="cs-focus_bg2">
                    ...
                    @foreach($products as $or)
                      ...
                      <th class="cs-width_1 cs-semi_bold cs-primary_color cs-text_center">
                        ...
                        @php($totalByLine += $totalByParentProduct)
                    ...
                    @endforeach
                    <th class="cs-width_1 cs-semi_bold cs-primary_color cs-text_center">
                      <p class="cs-primary_color cs-bold cs-f16 cs-m0 cs-text_center"><kbd>{{ $summary ? $totalByLine : $totalAllGrouped }}</kbd> </p>
                  ...
                  <table>
                    ...
                    <tbody>
                      ...
                      <tr class="cs-focus_bg">
                        ...
                        <th class="cs-width_1 cs-semi_bold cs-primary_color cs-text_center">
                          <u>{{ $summary ? $totalSec : $totalAllByProduct }}</u>
                ...
                <tbody>
                  <tr class="cs-table_baseline">
                    ...
                    <td class="cs-width_2 cs-text_rightcs-f16">
                      <p class="cs-primary_color cs-bold cs-f16 cs-m0 cs-text_center"><kbd>{{ $summary ? $totalTot : $totalAll }}</kbd> </p>
                    </td>
                  </tr>
                </tbody>
              </table>
