...
<x-backend.card>
  <x-slot name="header">
    ...
    <div class="card-header-actions">
        <x-utils.link class="card-header-action" icon="fa fa-close" :href="#" :text="__('Close this window')" />
    </div>
            ...
            <tr>
              <th scope="row" class="w-50">
                ...
                <small class="font-weight-bold text-dark"><i class="cil-plus" style="color:green;"></i> 
                    {{-- {{ $product->getTotalHistory($dateInput, $dateOutput, false) }} --}}
                </small>
              </th>
              <th scope="row" class="w-50">
                @lang('Outputs'):
                <small class="font-weight-bold text-dark"><i class="cil-minus" style="color:red;"></i>
                    {{-- {{ $product->getTotalHistory($dateInput, $dateOutput, true) }} --}}
                </small>
              </th>
            </tr>
          </tbody>
