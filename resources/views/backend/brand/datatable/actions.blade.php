<div class="btn-group" role="group" aria-label="Basic example">
    ...
    @if (!$brand->trashed())
        ...
        @if ($logged_in_user->hasAllAccess() || $logged_in_user->can('admin.access.brand.modify'))
            <x-actions-modal.edit-icon target="editBrand" emitTo="backend.brand.edit-brand" function="edit"
                :id="$brand->id" />
        @endif
    ...
    @else
        <div class="dropdown">
            <a class="btn btn-icon-only" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                aria-expanded="false">
