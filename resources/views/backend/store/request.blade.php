...
@section('content')
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						<li class="breadcrumb-item mr-4">
							<a href="{{ route('admin.store.all.requests') }}" class="text-white"><h3> @lang('List of requests')</h3></a>
						</li>
						<ul class="breadcrumb">
				...
				<div class="page-wrapper">
					...
					<div class="page-body">
						  ...
						  <div class="row">
							...
							<livewire:backend.cartdb.products :type="'request'" branchId="1"/>

							<livewire:backend.cartdb.summarydb :typeSummary="'request'" branchIdSummary="1"/>
	...
	<livewire:backend.cartdb.search-products :typeSearch="'request'" branchIdSearch="1"/>

	<livewire:backend.cartdb.create-customer :type="'request'" branchId="1"/>
