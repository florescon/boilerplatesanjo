    ...
    <div class="chat-module-top">
      ...
      @if($selectedtypes && $orders->count() && ($logged_in_user->hasAllAccess() || ($logged_in_user->can('admin.access.bom.list'))))
        <div class="dropdown table-export mb-4">
        	...
        	<button type="button" wire:click="sendMaterials" onmousedown="party.confetti(this)" class="buttonn btn btn-light mr-2"> @lang('Explode') </button>

          @error('selectedtypes') <span class="error" style="color: red;"><p>{{ $message }}</p></span> 
          @enderror
              ...
              <div class="row">
                <div class="form-group col">
                  ...
                  <div class="custom-control custom-checkbox col">
                    ...
                    <div>
                    	<a href="{{ route('admin.order.edit', $order->id) }}" target="_blank"><strong>#{{ $order->id }}</strong></a>
      ...
      <div class="chat-team-sidebar text-small">
        <div class="chat-team-sidebar-top">
          ...
          <ul class="nav nav-tabs nav-justified" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link {{ $tab == 'products' ? 'active' : '' }}" wire:click="$set('tab', 'products')"  id="products-tab" data-toggle="tab" href="#products" role="tab" aria-controls="products" aria-selected="true">@lang('Products')</a>
            </li>
            <li class="nav-item">
              <a class="nav-link {{ $tab == 'files' ? 'active' : '' }}" wire:click="$set('tab', 'files')"  id="files-tab" data-toggle="tab" href="#files" role="tab" aria-controls="files" aria-selected="false">@lang('Export')</a>
            </li>
          </ul>
          @endif
        </div>
        ...
        <div class="chat-team-sidebar-bottom">
          <div class="tab-content">
            <div class="tab-pane fade show {{ $tab == 'members' ? 'show active' : '' }}" id="members" role="tabpanel" data-filter-list="list-group">
              <form class="px-3 mb-3">
                <div class="input-group input-group-round">
                  ...
                  <input type="search" wire:model.debounce.350ms="searchFeedstock" class="form-control filter-list-input" placeholder="@lang('Filter feedstock')" aria-label="Filter feedstock">
                </div>
              </form>
            ...
            <div class="tab-pane fade show {{ $tab == 'products' ? 'show active' : '' }}" id="products" role="tabpanel" data-filter-list="list-group">
              {{-- <form class="px-3 mb-3">
                <div class="input-group input-group-round">
                  <div class="input-group-prepend">
                    <span class="input-group-text">
                  ...
                  @foreach($productsCollection as $product)
                    ...
                    @endphp
                      ...
                      <a class="list-group-item list-group-item-action" href="#">
                        <div class="media media-member mb-0">
                          <div class="media-body">
                            <h6 class="mb-0" data-filter-by="text">{!! $p[0]['productParentName'].' - '.$p[0]['productColorName'] !!}</h6>
              ...
              <ul class="list-group list-group-activity dropzone-previews flex-column-reverse list-group-flush" style="margin-bottom: 100px;">
                ...
                <li class="list-group-item ">
                  <div class="media align-items-center">
                    ...
                    <div class="media-body d-flex justify-content-between align-items-center">
                      <div>
                        <a href="#" wire:click="exportMaatwebsiteCustom('xlsx')" data-filter-by="text">Exportar por unidad de medida</a>
                        <br>
                      ...
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right ">
                          <a class="dropdown-item" href="#" wire:click="exportMaatwebsiteCustom('xlsx')">Excel</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="#" wire:click="exportMaatwebsiteCustom('csv')">CSV</a>
                          <a class="dropdown-item" href="#" wire:click="exportMaatwebsiteCustom('html')">HTML</a>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <li class="list-group-item ">
                  <div class="media align-items-center">
                    ...
                    <div class="media-body d-flex justify-content-between align-items-center">
                      <div>
                        <a href="#" wire:click="exportMaatwebsiteCustom('xlsx', 'vendor')" data-filter-by="text">Exportar por proveedor</a>
                        <br>
                        <span class="text-small" data-filter-by="text">Excel</span>
                      </div>
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right ">
                          <a class="dropdown-item" href="#" wire:click="exportMaatwebsiteCustom('xlsx', 'vendor')">Excel</a>
                          <div class="dropdown-divider"></div>
                          <a class="dropdown-item" href="#" wire:click="exportMaatwebsiteCustom('csv', 'vendor')">CSV</a>
                          <a class="dropdown-item" href="#" wire:click="exportMaatwebsiteCustom('html', 'vendor')">HTML</a>
                        </div>
                      </div>
                    </div>
                  </div>
