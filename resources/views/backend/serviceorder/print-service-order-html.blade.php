...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css_custom/invoice.css') }}">
...
<body>
  ...
  <script src="{{ asset('/css_custom/invoice/jquery.min.js') }}"></script>
  <script src="{{ asset('/css_custom/invoice/jspdf.min.js') }}"></script>
  <script src="{{ asset('/css_custom/invoice/html2canvas.min.js') }}"></script>
  <script src="{{ asset('/css_custom/invoice/main.js') }}"></script>
</body>
</html>
